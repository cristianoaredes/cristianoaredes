...
Connect AI assistants to real-world data and tools:

| Project | ⭐ Stars | Description |
|---------|---------|-------------|
| [**mcp-mobile-server**](https://github.com/cristianoaredes/mcp-mobile-server) | `7 ⭐` | Native mobile development (Android, iOS, Flutter) via AI |
| [**mcp-senado**](https://github.com/cristianoaredes/mcp-senado) | `2 ⭐` | Brazilian **Federal Senate** open data |
| [**mcp-camara**](https://github.com/cristianoaredes/mcp-camara) | `1 ⭐` | Brazilian **Chamber of Deputies** open data |
| [**mcp-dadosbr**](https://github.com/cristianoaredes/mcp-dadosbr) | `1 ⭐` | Brazilian **CNPJ** and **CEP** lookup |
| [**mcp-apple-store**](https://github.com/cristianoaredes/mcp-apple-store) | `0 ⭐` | Apple App Store Connect API |
| [**null-g-mcp**](https://github.com/cristianoaredes/null-g-mcp) | `1 ⭐` | Google Antigravity IDE control |
| [**null-g-proxy**](https://github.com/cristianoaredes/null-g-proxy) | `1 ⭐` | OpenAI-compatible HTTP proxy |

> 💡 **Use with**: Claude Desktop, Cursor, Windsurf, Continue.dev and other AI assistants
...
| Project | ⭐ Stars | Description |
|---------|---------|-------------|
| [**opencnpj**](https://github.com/cristianoaredes/opencnpj) | `1 ⭐` | Access to open CNPJ data |
...
- 💼 Open for collaborations on AI/Agents projects
- 💡 Interested in MCP servers and developer tools
- 🇧🇷 Special focus on Brazilian data and solutions
